const I18N = {
  de: {
    ...
    reliability: '<p>KI-Assistenten sind ein Recherchewerkzeug, keine Quelle. Zwei Eigenschaften sollten Sie als Historikerin oder Historiker im Blick behalten:</p>'
      ...
      + '<p><strong>Vorlagen, die die Streuung verringern.</strong> Zwei gleiche Antworten sind auch mit der besten Vorgabe nicht zu erwarten. Einschränken lässt sich aber, wie viel der Assistent selbst entscheidet: Der Server liefert sechs Vorlagen mit, die Suchweg und Ausgabe festlegen, darunter belegte Recherche, vollständige Trefferliste, Personendossier mit festen Feldern und eine Fremdprüfung, bei der jemand anders Ihr Ergebnis nachrechnet und die Abweichung benennt. Siehe den Abschnitt <a href="#vorlagen">Fertige Vorlagen im Assistenten</a>. Das macht Läufe besser vergleichbar und Auslassungen sichtbarer. Gleichheit garantiert es nicht. Siehe <a href="https://github.com/Archiv-fur-Agrargeschichte/AfA-MCP-Server/tree/main/docs/prompts">docs/prompts</a>.</p>'
  ...
  fr: {
    ...
    reliability: '<p>Les assistants IA sont un outil de recherche, pas une source. Deux caractéristiques méritent l\'attention de l\'historien ou de l\'historienne :</p>'
      ...
      + '<p><strong>Des modèles qui réduisent la dispersion.</strong> Deux réponses identiques ne sont pas à attendre, même avec la meilleure consigne. En revanche, on peut limiter ce que l’assistant décide lui-même : le serveur fournit six modèles qui fixent le chemin de recherche et la restitution, dont la recherche sourcée, la liste de résultats complète, le dossier de personne à champs fixes et une vérification par un tiers qui refait votre résultat et nomme l’écart. Voir la section <a href="#vorlagen">Modèles prêts à l’emploi</a>. Cela rend les exécutions plus comparables et les omissions plus visibles. Cela ne garantit pas l’identité. Voir <a href="https://github.com/Archiv-fur-Agrargeschichte/AfA-MCP-Server/tree/main/docs/prompts">docs/prompts</a>.</p>'
  ...
  it: {
    ...
    reliability: '<p>Gli assistenti IA sono uno strumento di ricerca, non una fonte. Due caratteristiche meritano l\'attenzione dello storico o della storica:</p>'
      ...
      + '<p><strong>Modelli che riducono la dispersione.</strong> Due risposte identiche non sono da attendersi nemmeno con la migliore indicazione. Si può però limitare quanto decide l’assistente da sé: il server fornisce sei modelli che fissano il percorso di ricerca e la restituzione, fra cui ricerca documentata, elenco completo dei risultati, dossier personale a campi fissi e una verifica esterna con cui un’altra persona ricalcola il vostro risultato e nomina lo scostamento. Vedi la sezione <a href="#vorlagen">Modelli pronti</a>. Questo rende le esecuzioni più confrontabili e le omissioni più visibili. Non garantisce l’identità. Vedi <a href="https://github.com/Archiv-fur-Agrargeschichte/AfA-MCP-Server/tree/main/docs/prompts">docs/prompts</a>.</p>'
  ...
  en: {
    ...
    reliability: '<p>AI assistants are a research tool, not a source. As a historian, keep two properties in mind:</p>'
      ...
      + '<p><strong>Templates that narrow the spread.</strong> Two identical answers are not to be expected, not even with the best instructions. What can be limited is how much the assistant decides on its own: the server ships six templates that fix the search path and the output, among them sourced research, a complete result list, a person dossier with fixed fields and a third party check in which someone else redoes your result and names the deviation. See the section <a href="#vorlagen">Ready-made templates</a>. That makes runs more comparable and omissions more visible. It does not guarantee sameness. See <a href="https://github.com/Archiv-fur-Agrargeschichte/AfA-MCP-Server/tree/main/docs/prompts">docs/prompts</a>.</p>'
